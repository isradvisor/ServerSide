...
namespace IsraVisor_server.Controllers
{
    ...
    {
        // GET api/<controller> מקבל את רשימת הערים מהSQL
        ...
        // GET api/<controller>/5 מקבל רשימת ערים שמדריך בחר
        ...
        // POST api/<controller> מכניס את כל הערים ל SQL
        ...
        // DELETE api/<controller>/5 מוחק את רשימת הערים של המדריך
        [HttpDelete]
